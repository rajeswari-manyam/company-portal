// Display label → backend enum value mapping
// Backend accepts: sick | annual | casual | maternity | paternity | unpaid
...
export const DEPARTMENTS_DEFAULT = [
  'Engineering','HR','Marketing','Finance','Design','Management','Operations',
] as const;
...
// ── Nav arrays — icon field now uses lucide icon name strings ─────────────────
// The Sidebar component imports lucide icons and maps them via ICON_MAP[to].
// The icon string here is kept for any legacy consumers; Sidebar ignores it.
