...
// ══════════════════════════════════════════════════════════════════════════════
// src/pages/hr/HRRouter.tsx  (UPDATED)
// ══════════════════════════════════════════════════════════════════════════════
...
import HRExcelSheets   from "./HRExcelSheet" ; // ← NEW
import HRReports       from "./HRReports"   ;    // ← NEW
  ...
  return (
    <Routes>
      <Route element={<HRLayout />}>
        ...
        <Route path="projects"      element={<HRProjects role="hr" />} />
        ...
        <Route path="excelSheets"   element={<HRExcelSheets />} />
