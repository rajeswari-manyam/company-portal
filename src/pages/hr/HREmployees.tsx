  ...
  return (
    ...
    >
      ...
      <div className="p-5 pb-4">
        ...
        {/* Name + designation */}
        <h3 className="font-bold text-slate-900 text-base leading-tight group-hover:text-[#0B0E92] transition-colors duration-200">
          {user.name}
        </h3>
    ...
    return users.filter((u) => {
      ...
      const matchStatus =
        statusFilter === 'All'
          ...
          ? !u.firstLogin
          : u.firstLogin;
      // ✅ FIX: Compare against both d.id and d._id to handle either shape
      const matchDept =
        deptFilter === 'All' ||
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">
                {filtered.length} of {nonAdminTotal} total
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            >
              ...
              {departments.map((d: Department) => (
                // ✅ FIX: Use (d as any)._id ?? d.id to support both shapes
                <option key={(d as any)._id ?? d.id} value={(d as any)._id ?? d.id}>
                  {d.name}
                </option>
              ))}
            </select>
